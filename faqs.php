...
<?php include './include/navbar.php';?>
    ...
    <div class="row g-3 align-items-center">
        ...
        <p>Pizza has a lot of strong opinions. Food and taste is subjective. I've made this project open source so that anyone can tailor the calculator to their own tastes and needs. The Github project can be found <a href="<?=GITHUB_ROOT;?>">here</a>.</p>
