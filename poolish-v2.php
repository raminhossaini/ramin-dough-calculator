...
<div class="container">
    ...
    <h2>Poolish 24-hour Pizza Dough (Version 2)</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-2 w-auto">
            <div class="input-group mb-3">
            <span class="input-group-text">Poolish Percentage</span>
    ...
    <div class="row mb-3">
        ...
        <p>
            ...
            Use a higher poolish percentage in colder months and lower percentage in warmer months.
        </p>
