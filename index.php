...
printImageBlock(ORIGINAL, "./img/poolish.png", "Original 24-hour Pizza Dough", "A Neapolitan pizza made with a poolish preferment boasts a light, airy crust with subtle complexity and a delicate tang from its long, slow fermentation. Now with percentage control of the poolish. <strong>If you are a returning user, this was the default landing page.</strong>");
printImageBlock(DOUBLE_FERMENTED, "./img/double-fermented.png", "Double-fermented 48-hour Pizza Dough", "A Neapolitan pizza made with a double-fermented poolish preferment delivers an exceptionally light, flavorful crust with deep aroma and nuanced tang from its extended, two-stage fermentation. Now with percentage control of the poolish.");
